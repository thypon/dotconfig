...
TERM = if File.exists? "/usr/bin/alacritty" then "alacritty"
       ...
       elsif File.exists? "/usr/bin/st" then "st -f Inconsolata:style=Regular:size=16:antialias=true"
...
grab "XF86MonBrightnessUp", "xbacklight -inc 10 || echo $(($(cat /sys/class/backlight/edp-backlight/brightness) + 409)) > /sys/class/backlight/edp-backlight/brightness"
grab "XF86MonBrightnessDown", "xbacklight -dec 10 || echo $(($(cat /sys/class/backlight/edp-backlight/brightness) - 409)) > /sys/class/backlight/edp-backlight/brightness"
...
grab "W-Return", "exec #{TERM} -e subtle-session"
...
tag "document", "zathura|okular|CuteMarkEd|Xournal|Foxit|Libreoffice|cherrytree|rednotebook"
